 ...
 */
public class Leviator extends ObjetTouchable {
	/**
	...
	private int vie=100;
        ...
        private int xp = 0;
        private boolean hydroblastActif = false;
        private int compteurHydroblast = 0;
        private int i = 0;
         ...
         * @param actualistion 
         */
        public Leviator(Game g, int x, int y, GestionMap actualistion){
            super(g,"leviator",x,y);   
	...
	public void
        move(long dt) {
            ...
            if(hydroblastActif){
                ...
                if(i>=250){
                    i -= 250;
                    Hydroblast hydroblast = new Hydroblast(this, e);
                    game().add(hydroblast);
                    compteurHydroblast ++;
                }
                if(compteurHydroblast >5){
                    hydroblastActif = false;
                    i = 0;
                    compteurHydroblast = 0;
                }
            }
