 ...
 */
public class Hydroblast extends ObjetTouchable {
    private final double vitesse=0.15;
    private int oldXCord;
    private int oldYCord;
    
        public Hydroblast(ObjetTouchable source, Ennemi aAttaquer){
            super(source.game(),"hydroblast",source.getMiddleX(),source.getBottom());
