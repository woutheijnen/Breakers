 ...
 */
public class Ronfle extends ObjetTouchable {
    private final double vitesse=0.15;
    private final int oldXCord;
    private final int oldYCord;
    
        public Ronfle(ObjetTouchable source, Ennemi aAttaquer){
            super(source.game(),"ronfle",source.getMiddleX(),source.getBottom());
