 ...
 */
public class BouleDeDragon2 extends Ennemi {
    private final double vitesse=0.15;
    private int oldXCord;
    private int oldYCord;
    private GestionMap ge;
    
        public BouleDeDragon2(Ennemi source, int x, int y, GestionMap ges){
            super(source.game(),"boule_feu2",source.getLeft(),source.getMiddleY());
