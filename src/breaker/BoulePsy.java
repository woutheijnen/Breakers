 ...
 */
public class BoulePsy extends ObjetTouchable {
    private final double vitesse=0.1;
    private final int oldXCord;
    private final int oldYCord;
    
        /**
         * Constructeur de la classe BoulePsy
         * @param source
         * @param aAttaquer 
         */
        public BoulePsy(ObjetTouchable source, Ennemi aAttaquer){
            super(source.game(),"boulePsy",source.getMiddleX(),source.getBottom());
