 ...
 */
public class BombExplosionF4 extends Ennemi {
    private GestionMap ge;
        
        public BombExplosionF4(Ennemi source, GestionMap gestion){
            super(source.game(),"BombExplosionF4",source.getLeft(),source.getTop());
            ge = gestion;
        }
	/**
	...
	public void move(long dt) {
            if(!ge.isExplosionPossible()){
                ...
                if(aleatoire>=40 && aleatoire <150){
                    BombExplosionF5 exp5 = new BombExplosionF5(this, ge);
                    game().add(exp5);
                    game().remove(this);
            }
	}
