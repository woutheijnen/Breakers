 ...
 */
public class Magicarpe extends ObjetTouchable {
	/**
	...
	private int vie=20;
        ...
        public Magicarpe(Game g, int x, int y, GestionMap actualistion){
            super(g,"magicarpe",x,y);   
	...
	public void
        move(long dt) {
            ...
            xp += dt;
            if(xp >= 20000){
                Leviator leviator = new Leviator(game(), this.getLeft(), this.getTop(), gestion);
                game().add(leviator);
