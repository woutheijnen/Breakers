...
public class BouleDeFeu extends Ennemi {
    private final double vitesse=0.09;
    private int oldXCord;
    private int oldYCord;
    
        public BouleDeFeu(Ennemi source, GestionMap ges){
            super(source.game(),"BouleDeFeu",source.getLeft(),source.getMiddleY());
