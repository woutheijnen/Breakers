 ...
 */
public class Link extends Ennemi {
	...
	private int vie=25;
        ...
        public Link(Game g, int x, int y,GestionMap gm){
            super(g,"link",x,y);            
            joueur = gm.getPlayer();
            gestion = gm;
        }
	...
	public void
            ...
            if(aleatoire>=311 && aleatoire <=320){
                tirerSp3();
            }
	}
	...
	*/
    ...
    protected void tirer() {
        LinkEpee ep = new LinkEpee(this, joueur.getMiddleX(), joueur.getMiddleY(), gestion);
        game().add(ep);
    }
        /*
    ...
    protected void tirer2() {
        ...
        LinkEpee ep = new LinkEpee(this, aleaX, aleaY, gestion);
        game().add(ep);
    }
    
    protected void tirerSp3() {
        Audio a = new Audio("linksp");
        a.start();
        
        BombEnnemi bmb = new BombEnnemi(this, 0, 0, gestion, 0);
        game().add(bmb);
    }
        /*
    ...
    protected void tirerSp(){
        LinkShield sh = new LinkShield(this);
        game().add(sh);
    }
        /*
    ...
    protected void tireSp2(){
        ...
        LinkHache s = new LinkHache(this, gestion);
        game().add(s);
    }
