 ...
 */
public class BouleOmbre extends ObjetTouchable {
    private final double vitesse=0.1;
    private int oldXCord;
    private int oldYCord;
    
        /**
         * Constructeur de la classe BouleOmbre
         * @param source
         * @param aAttaquer 
         */
        public BouleOmbre(ObjetTouchable source, Ennemi aAttaquer){
            super(source.game(),"bouleOmbre",source.getMiddleX(),source.getBottom());
